...
/* UART Offset */
	 ...
	 * UART_PutChar
	 *
	 * Transmit or put a char to UART0/serial interface (according to the 
...
2:
	 ...
	 *
	 * C prototype: void UART_PutString(const char *str, const uint32_t len) 
	 **********************************************************************/
	.section .text
	.code 32
	.align 2
...
UART_PutString:
	...
	mov	r2, r0
1:
	ldrb	r0, [r2]		/* Why can't we use "ldrb r0,[r2]!"? */
	add	r2, r2, #1
	and	r0, r0, #0xFF
	cmp	r0, #0x0
	beq	10f
